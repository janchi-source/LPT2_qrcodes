...
const VERZIA = '1.2.0-prazdne-telo';
...
async function handleApi(req, res, pathname) {
  ...
  if (pathname === '/api/db-test') {
    ...
    return sendJSON(res, v.ok ? 200 : 503, {
      ...v,
      napoveda: v.ok ? undefined : [
        'Skontroluj, či je databáza priradená k projektu a či si po jej pridaní spustil Redeploy.',
        ...
        'Ak zlyhá až krok EVAL, poskytovateľ zakazuje Lua skripty — napíš mi to, viem to prepísať bez nich.',
      ],
    });
  }
